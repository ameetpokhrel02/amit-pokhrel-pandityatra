              ...
              <div className="flex gap-2">
                ...
                <Dialog open={isMapOpen} onOpenChange={setIsMapOpen}>
                  <DialogTrigger asChild>
                    <Button variant="outline" size="icon" className="shrink-0 border-orange-200 text-orange-600 hover:bg-orange-50">
                  ...
                  <DialogContent className="sm:max-w-[600px] bg-white">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Search for your birth place or click on the map to pick exact coordinates.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
                      <MapPicker
                        ...
                        initialAddress={formData.placeOfBirth}
                        onLocationSelect={(loc) => {
                          handleInputChange('placeOfBirth', loc.address);
                    ...
                    <DialogFooter>
                      <Button onClick={() => setIsMapOpen(false)}>Done</Button>
                    </DialogFooter>
                  </DialogContent>
                </Dialog>
              </div>
