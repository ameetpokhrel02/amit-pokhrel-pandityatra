...
const AppDownloadSection: React.FC = () => {
    ...
    return (
        <section
            className="relative overflow-hidden bg-cream py-20 px-4 md:px-8"
            ...
            <div className="container mx-auto max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col space-y-8 z-10 pointer-events-none md:pointer-events-auto">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <motion.a
                                    href="#"
                                    className="bg-black text-white px-6 py-3 rounded-xl flex items-center space-x-3 hover:bg-gray-900 transition-colors border border-gray-800"
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                >
                                    <img src={playstoreLogo} alt="Play Store" className="w-8 h-8 object-contain rounded-md" />
                                ...
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                >
                                    <img src={appleLogo} alt="App Store" className="w-8 h-8 object-contain rounded-md" />
                                    <div className="text-left">
                            ...
                            <div className="mt-10 flex items-center space-x-4">
                                ...
                                <div>
                                    <p className="font-bold text-dark-brown">50k+ <span className="font-normal text-gray-600">Downloads</span></p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="relative flex justify-center items-center perspective-1000">
                        ...
                        <div className="absolute w-[500px] h-[500px] bg-saffron/10 rounded-full blur-3xl -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></div>
                        ...
                        >
                            <img
                                ...
                                // Modified classes: Removed border-8, bg-gray-900. kept rounded for basic corner rounding if image needs it, but reducing complexity.
                            ...
                            <motion.div
                                className="absolute top-20 -left-12 bg-white p-4 rounded-xl shadow-xl flex items-center space-x-3 z-20"
                                style={{
                            ...
                            <motion.div
                                className="absolute bottom-32 -right-8 bg-white p-4 rounded-xl shadow-xl z-20"
                                style={{
