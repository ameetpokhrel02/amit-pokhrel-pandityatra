...
import { Loader2, MessageSquareHeart, Send, Star, CheckCircle2, Store } from 'lucide-react';
import { fetchSiteReviews, submitSiteReview } from '@/lib/api';
import { useToast } from '@/hooks/use-toast';

const VendorAppFeedback = () => {
  ...
  const handleFeedbackSubmit = async () => {
    ...
    try {
      ...
      toast({ title: 'Feedback submitted', description: 'Thank you for your feedback as a vendor.' });
    } catch (err: any) {
    ...
    <DashboardLayout userRole="vendor">
      <div className="space-y-6 max-w-3xl">
        <div>
          ...
          <p className="text-muted-foreground">Share your experience as a vendor and help us improve the marketplace.</p>
        </div>
        ...
        <Card className="border-blue-100 bg-gradient-to-r from-blue-50/50 to-white">
          <CardContent className="pt-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold text-lg">PanditYatra Global Rating</h3>
        ...
        {feedbackSubmitted ? (
          <Card className="border-green-200 bg-green-50/30">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-green-600 mt-2">Your feedback has been submitted successfully. Your rating helps build trust in our community.</p>
            </CardContent>
          </Card>
        ) : (
          <Card>
            <CardHeader>
              ...
              <CardDescription>How smooth has it been to manage your products and orders on PanditYatra?</CardDescription>
            </CardHeader>
            <CardContent className="space-y-5">
              <div>
                <label className="text-sm font-medium text-slate-700 block mb-2">Platform Rating</label>
              ...
              <div>
                <label className="text-sm font-medium text-slate-700 block mb-1.5">Your Review</label>
                <Textarea
                  placeholder="Tell us about order management, payout experience, or any features you'd like to see..."
            ...
            <CardFooter>
              <Button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-full font-semibold text-base py-5"
              >
...
export default VendorAppFeedback;
