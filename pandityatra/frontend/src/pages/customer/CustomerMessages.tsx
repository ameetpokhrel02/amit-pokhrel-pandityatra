...
const CustomerMessages: React.FC = () => {
      ...
      try {
        ...
        if (data.type === 'message') {
          ...
          setMessages((prev) => {
            ...
            // We check if a message with the same content and very recent timestamp exists
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setNewMessage(messageContent); // Restore content so they can try again
    } finally {
    ...
    <DashboardLayout userRole="user">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Chat history with pandits you've contacted.</p>
        </div>
                ...
                <div className="text-center space-y-4 max-w-sm">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed font-medium">
                      Select a conversation on the left to start coordinating your sacred rituals with your chosen pandit.
                    </p>
                  </div>
                </div>
              </CardContent>
